...
from users.views import SendPasswordResetView, UserChangePasswordView, UserPasswordResetView, UserProfileView, UserRegistrationView,UserLoginView,UpdateUserView
